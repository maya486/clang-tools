...
[Debug] Done traversing Function Body for union accesses
  Variable: in (4 accesses)
    ...
    Field: flt | WRITE | at /home/mrebholz/clang-tools/tests/conversion/in/simple3.cpp:11
    Field: flt | READ | at /home/mrebholz/clang-tools/tests/conversion/in/simple3.cpp:11
    Field: num | READ | at /home/mrebholz/clang-tools/tests/conversion/in/simple3.cpp:12
[Debug] counts: writes_a=2 reads_a=1 writes_b=0 reads_b=1
[Debug] Found enclosing CompoundStmt for: in.flt
[Debug] CompoundStmt: {
    union (unnamed union at /home/mrebholz/clang-tools/tests/conversion/in/simple3.cpp:5:5) in;
    uint32_t n, j;
    in.flt = flt;
    in.flt = in.flt + 3;
    return in.num;
